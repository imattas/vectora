...
const STEPS = [
  ['01 / WRITE', 'Your equations are the workspace', 'Click the editor and type ordinary math. Vectora updates the graph as you work — curves, fields, geometry, probability, and 3D scenes use the same surface.', 'Try: y = sin(x) or x^2 + y^2 = 4'],
